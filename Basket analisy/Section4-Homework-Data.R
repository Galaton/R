...
rownames(FreeThrows) <-  c("2005","2006","2007","2008","2009","2010","2011","2012","2013","2014")
...
#Matrix
#
FreeThrowsAttempts <- cbind(KobeBryant_FTA, JoeJohnson_FTA, LeBronJames_FTA, CarmeloAnthony_FTA, DwightHoward_FTA, ChrisBosh_FTA, ChrisPaul_FTA, KevinDurant_FTA, DerrickRose_FTA, DwayneWade_FTA)
rownames(FreeThrowsAttempts) <-Seasons
colnames(FreeThrowsAttempts) <- Players
FreeThrowsAttempts
...
#free throw attremps per game

FreeThrowsAttemptsPerGame <- FreeThrowsAttempts/t(Games)
FreeThrowsAttemptsPerGame

AcuracyFreeThrows <- (FreeThrows*100)/FreeThrowsAttempts
AcuracyFreeThrows

#Player Style--------------------------------------------------
style <- (Points - t(FreeThrows))/FieldGoals
style
...
CriarGrafico(1:12,Points)

CriarGrafico(1:12,t(AcuracyFreeThrows))

CriarGrafico(1:12,style)
